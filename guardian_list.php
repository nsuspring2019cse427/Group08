<?php
  ...
  $sql = "SELECT m.fname AS m_fname, m.lname AS m_lname,
          g.fname AS g_fname, g.lname AS g_lname, g.address AS g_address, g.email AS g_email, g.relationship AS g_relationship
...
<html lang="en">
  <head>
    ...
    <title>Guardian List :: OAHM</title>
